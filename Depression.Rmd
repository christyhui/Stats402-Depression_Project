...
depression$Financial.Stress = factor(depression$Financial.Stress, levels = c(1, 2, 3, 4, 5), ordered = TRUE)
...
$$
\text{logit}(p) = 4.069 - 0.236*Age + 0.219 * Work.Study.Hours + \newline  3.180 * Pressure1 - 0.240 * Pressure2 - 0.002 * Pressure3 + 0.039 * Pressure4 - \newline 2.341 * Satisfaction1 + 0.040 * Satisfaction2 + 0.028 * Satisfaction3 + 0.148 * Satisfaction4 + \newline 1.860 * FinancialStress1 + 0.149 * FinancialStress2 - 0.139 * FinancialStress3 + 0.208 * FinancialStress4
$$
